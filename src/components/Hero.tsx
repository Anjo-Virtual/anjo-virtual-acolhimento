      ...
      <div className="container mx-auto px-6 w-full">
        <div className="max-w-xl animate-fadeInUp">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a 
              href="#" 
              className="bg-primary text-white px-8 py-3 rounded-button hover:bg-opacity-90 transition-all duration-300 hover:translate-y-[-2px] hover:shadow-soft text-center whitespace-nowrap animate-scaleIn"
            >
