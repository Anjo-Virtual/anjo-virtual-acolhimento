            ...
            <DialogContent className="max-w-md mx-auto">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row justify-end gap-2">
                  <Button variant="outline" onClick={() => setShowNewMessage(false)} className="w-full sm:w-auto">
                    Cancelar
                  </Button>
                  <Button onClick={handleSendMessage} className="flex items-center gap-2 w-full sm:w-auto">
                    <Send size={16} />
                    Enviar
                  </Button>
                </div>
